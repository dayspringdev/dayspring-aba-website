    ...
    <AnimatedSection id="about" className="py-20 bg-gradient-soft scroll-mt-20">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="bg-card/80 backdrop-blur-sm border border-border/50 shadow-warm overflow-hidden">
            <CardContent className="p-8 md:p-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-center">
                {/* Image Column */}
                <div className="md:col-span-1 flex justify-center">
                  <Image
                    src="/tosin-portrait.jpg"
                    alt="Headshot of Tosin Ikotun, Clinical Director of Dayspring BTS"
                    width={192}
                    height={192}
                ...
                <div className="md:col-span-2 space-y-6">
                  ...
                  {/* === CHANGE IS HERE === */}
                  {/* Credentials Icons with Hover Effect */}
